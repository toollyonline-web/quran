        ...
        <div className="flex items-center gap-3">
          {deferredPrompt && (
            <button
              ...
              className="hidden items-center gap-2 rounded-xl bg-emerald-600 px-4 py-2 text-xs font-bold text-white shadow-md transition-all hover:bg-emerald-700 sm:flex"
            >
          ...
          <div className="mx-4 mt-2 rounded-3xl bg-white p-4 shadow-2xl ring-1 ring-slate-200 dark:bg-slate-900 dark:ring-slate-800">
            <div className="flex flex-col gap-1">
              ...
              {deferredPrompt && (
                <button
                  onClick={handleInstallClick}
                  className="mt-2 rounded-2xl bg-emerald-600 px-4 py-3 text-sm font-bold text-white transition-colors hover:bg-emerald-700"
                >
